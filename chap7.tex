...
Speakers, when used, let exhibit-goers hear how vibrations, which they themselves can make by tapping on the table, reverberate through the mirrors and and be both seen on-screen and heard as fringes pass the photodiode.
...
Based on the kiosk interferometer, we collaborated with Marco Cavaglia on a larger interferometer for the World Science Festival (WSF).
