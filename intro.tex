...
Spacetime is stiff.
Knowing that the Hubble time is roughly $8\times 10^{60}$ in geometric units, we need to look distances on the order of $10^{59} P_L$ Planck lengths, $\mathcal{O}$(50 Megaparsec), as the horizon for seeing at least one inspiral per year.
...
Accurate astrophysical estimates, elucidated now, will let us best pursue these faints signals.
