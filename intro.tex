...
Noise intrinsic to the optical configuration of these instruments is subtracted post-facto by LIGO feedforward filtering with \textit{Auxiliary MICH-PRC Subtraction} using recorded servo data in Chapter \ref{chap3}. 
...
Chapters \ref{chap5} and \ref{chap6} use these expectations to enhance and run \textit{TwoSpect} analyses of simulated and real data, particularly for Scorpius X-1 and XTE J1751-305.
