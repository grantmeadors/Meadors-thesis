...
Already a capable search for unknown systems across the entire sky, the author modified the search to focus on Scorpius X-1 and XTE J1751-305, having honed methods on a simulated set of data in collaboration and competition with fellow searchers.
These preliminary results will soon be presented and may be among the best so far.
...
Indeed, enhancements are possible between now and then that may make yet more capable.
...
As a fellow scientist\footnote{Brian O'Reilly of Livingston.} noted, Kepler saw two supernova in the Milky Way in his lifetime; there have been none since.
