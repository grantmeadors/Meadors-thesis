...
A 95\% confidence level requires (Equation~\ref{S6_UL_formula}) a correction factor of $h_0 \times \left(1+2.0 \right) \left[\cos \iota \textup{ factor} \right]$.
...
Tables~\ref{ScoX1S6outlierTableHF1} to~\ref{ScoX1S6outlierTableHF3} in Appendix~\ref{appendix3} present a list of outliers present in both intereferometers between 360 and 2040 Hz.
